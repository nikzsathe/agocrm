...
<!-- Main Sidebar Container -->
      <aside class="main-sidebar sidebar-dark-primary elevation-4 sidebar-no-expand bg-gradient-navy">
        ...
        <img src="<?php echo validate_image($_settings->info('logo'))?>" alt="Store Logo" class="brand-image  " style="width: 2.3rem;height: 2.0rem;max-height: unset;object-fit:scale-down;object-position:center center">
            ...
            <div class="os-viewport os-viewport-native-scrollbars-invisible" style="overflow-y: scroll;">
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                ...
                <nav class="mt-4">
                 ...
                 <!-- <li class="nav-item">
                    <a href="    <?php include $view.'.php' ?>" class="nav-link nav-lead">
                    ...
                    <li class="nav-item"><a href="./?page=leads/manage_lead" class="nav-link nav-opportunities"><span class="nav-icon fas fa-circle"></span>  Add New Leads</a>
                      <!-- <a href="<?php echo base_url ?>./?page=leads/Add New Lead" class="nav-link nav-opportunities">
                        <i class="nav-icon fas fa-circle"></i>
                        <p>
                           Create Leads
                        </p>
