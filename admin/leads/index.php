				...
				<div class="list-group-item list-group-item-action list-item rounded-0">
					...
					<div class="row">
						<div class="col-lg-6 col-sm-12">
							...
							<div class="d-flex">
								<div class="col-auto text-muted pl-3">Customer :</div>
					...
					<span class="text-muted"><em>Delivered by <?= isset($user_arr[$row['user_id']]) ? ucwords($user_arr[$row['user_id']]) : "N/A" ?> <?= date("D M d, Y h:i A",strtotime($row['date_created'])) ?></em></span>
					<div class="clear-fix my-2"></div>
					<div class="text-right">
						<a class="btn btn-sm btn-flat btn-light border" href="./?page=view_lead&id=<?= $row['id'] ?>"><i class="fa fa-eye"></i> View Lead</a>
						<?php if($_settings->userdata('type') == 1): ?>
