...
<div class="content py-3">
    <div class="card card-outline card-navy shadow rounded-0">
            ...
            <div class="container-fluid">
                <form action="" id="lead-form">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <fieldset>
                                ...
                                <div class="callout rounded-0 shadow">
                                    ...
                                    <div class="form-group">
                                        <label for="dou" class="control-label">Date of uploding</label>
                                        <input type="date" name="dou" id="dou" class="form-control form-control-sm form-control-border" value ="<?php echo isset($dou) ? $dou : '' ?>" required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="contact" class="control-label">Phone no</label>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <fieldset>
                                <legend class="text-muted h4"></legend>
                                <div class="callout rounded-0 shadow">
                                    ...
                                    <div class="form-group">
                                        <label for="source_id" class="control-label">Product Name</label>
                                   ...
                                   <!-- <div class="form-group">
                                    <label for="interested_in" class="control-label"> Product Name </label>
                                        <select name="interested_in" id="interested_in" class="form-control form-control-sm form-control-border select2" required>
                                            <option value="0" <?= isset($interested_in) && $interested_in == 0 ? 'selected' : '' ?>>ZANTAC LAWSUIT</option>
                                            <option value="1" <?= isset($interested_in) && $interested_in == 1 ? 'selected' : '' ?>>TALCUM BABY POWDER</option>
                                            <option value="2" <?= isset($interested_in) && $interested_in == 2 ? 'selected' : '' ?>>CAMP LEJEUNE</option>
                                            <option value="3" <?= isset($interested_in) && $interested_in == 3 ? 'selected' : '' ?>>ELMIRON</option>
                                            <option value="4" <?= isset($interested_in) && $interested_in == 4 ? 'selected' : '' ?>>ROUNDUP LAWSUIT</option>
                                            <option value="4" <?= isset($interested_in) && $interested_in == 5 ? 'selected' : '' ?>>HERNIA MESH</option>
                                            </select>
                                    </div> -->
                                    ...
                                    <div class="form-group">
                                        <label for="assigned_to" class="control-label">Send to Admin</label>
                                        <select name="assigned_to" id="assigned_to" class="form-control form-control-sm form-control-border select2" >
                                           
                                            <option value="admin" <?= isset($assigned_to) && $user_id == null ? 'selected' : '' ?>>Quality</option>
                                            
                                        </select>
                                    </div>
                                    
                                    <div class="form-group">
                                        <label for="assigned_to" class="control-label">From the agent </label>
                                        <select name="assigned_to" id="assigned_to" class="form-control form-control-sm form-control-border select2" >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="status" id="status" class="form-control form-control-sm form-control-border select2" required>
                                            <option value="0" <?= isset($status) && $status == 0 ? 'selected' : '' ?>>Send for verification</option>

                                         
                                            <?php if($_settings->userdata('type') == 1): ?>
                                            <option value="1" <?= isset($status) && $status == 1 ? 'selected' : '' ?>>Approved</option>
                                          
                                            <option value="2" <?= isset($status) && $status == 1 ? 'selected' : '' ?>>Rejected</option>
                                            <option value="3" <?= isset($status) && $status == 1 ? 'selected' : '' ?>>Verified</option>
                                            <option value="4" <?= isset($status) && $status == 1 ? 'selected' : '' ?>>Non Verified</option>

                                            <?php endif; ?>
                                            
                                            <!-- <option value="3" <?= isset($status) && $status == 1 ? 'selected' : '' ?>>Not a Target</option>
                                            <option value="4" <?= isset($status) && $status == 1 ? 'selected' : '' ?>>Disqualified</option>
                                            <option value="5" <?= isset($status) && $status == 1 ? 'selected' : '' ?>>Nurture</option>
                                            <?php if(isset($status) && $status == 6): ?>
                                            <option value="6" <?= isset($status) && $status == 1 ? 'selected' : '' ?>>Opportunity Created</option>
                                            <?php endif; ?>
                                            <option value="7" <?= isset($status) && $status == 1 ? 'selected' : '' ?>>Opportunity Lost</option>
                                            <option value="8" <?= isset($status) && $status == 1 ? 'selected' : '' ?>>Inactive</option> -->
        ...
        <div class="card-footer py-2 text-right">
                <button class="btn btn-primary btn-flat" type="submit" form="lead-form">Upload Lead Information</button>
