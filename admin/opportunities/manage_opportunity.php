    ...
    <div class="card card-outline card-navy shadow rounded-0">
        <div class="card-header">
            <div class="card-title">
                <h5 class="card-title"><?= !isset($id) ? "Add New Lead" : "'s Information - ".$code ?></h5>
            </div>
        </div>
        <div class="card-body">
            <div class="container-fluid">
                <form action="" id="lead-form">
                    ...
                    <input type="hidden" name="in_opportunity" value="1">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <fieldset>
                                ...
                                <div class="callout rounded-0 shadow">
                                    <div class="form-group">
                                        <label for="" class="control-label">Interested In</label>
